...
**Theorem 3** (Necessary and sufficient condition of $z$-identification) Let $X, Y, Z$ be disjoint sets of variables and $\mathcal{G}$ be the causal diagram. $Q=p(y\vert\mathrm{do}(x))$ is $z$-identifiable from $p$ in $\mathcal{G}$ if the
