...
**Remark.** This conclusion has a counterfactual interpretation: For all $x$ in the domain of $X,$ the counterfactual $Y_x$ is conditionally independent of $X$ given $Z$: $Y_x\perp X\ \vert\ Z.$
