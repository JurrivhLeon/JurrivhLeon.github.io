...
**Rule 1** (Insertion/deletion of observations).
  <p>$$p(y\vert \mathrm{do}(x), z, w) = p(y\vert\mathrm{do}(x),w)\ \ \ \textsf{if}\ (Y\perp Z\vert X,W)_{\mathcal{G}_{\overline{X}}};$$</p>
...
**Rule 3** (Insertion/deletion of actions).
  <p>$$p(y\vert \mathrm{do}(x),\mathrm{do}(z), w) = p(y\vert\mathrm{do}(x), w)\ \ \ \textsf{if}\ (Y\perp Z\vert X,W)_{\mathcal{G}_{\overline{X},\overline{Z(W)}}},$$</p>
