...
<div align=center>
   <img src='https://github.com/JurrivhLeon/JurrivhLeon.github.io/raw/main/figs/causalDAG5.png' width='648.9'/> 
</div>
...
1. $Z^+$ blocks all backdoor paths from $C$ to $Y$ in $\mathcal{G}_S$;
