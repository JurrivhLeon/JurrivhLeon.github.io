...
<p>
   ...
   &= \sum_z p(y\vert\mathrm{do}(x), z)p^{*}(z|x). \tag{6}
   \end{align}$$
</p>
...
+ Paul, H. and E. Bareinboim (2023). Causal Inference and Data Fusion in Econometrics. *The Econometrics Journal, pp. 1–44.*
