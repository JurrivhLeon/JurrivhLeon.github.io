...
**Theorem 1.** Suppose that Assumption 1 holds. If there exist functions $h_1:\mathcal{Z}\times\mathcal{A}\times\mathcal{X}\to\mathbb{R}$ and $g:\mathcal{A}\times\mathcal{X}\to\mathbb{R}$ satisfying:
<p>$$\begin{align*}
   &\mathbb{E}_\mathrm{obs}[h_1(Z,A,X) - Y|Z,R_Z=1] = 0 \ \ \mathrm{a.s.},\\
   &\mathbb{E}_\mathrm{obs}[g(A,X) - h_1(Z,A,X)|Z,A,X,(R_Z,R_X)=\mathbf{1}] = 0\ \ \mathrm{a.s.},
\end{align*}$$</p>
...
On the other hand,
<p>$$\begin{align*}
   \mathbb{E}_\mathrm{obs}[Y|Z,R_Z=1] &= \mathbb{E}_\mathrm{obs}[h_1(Z,A,X)|Z,R_Z=1]\\
   &= \mathbb{E}_\mathrm{obs}\left[\mathbb{E}_\mathrm{obs}[h_1(Z,A,X)|Z,A,X,(R_Z,R_X)=\mathbf{1}]|Z,R_Z=1\right]\\
